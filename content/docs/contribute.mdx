...
Mythic is an open-source app that is published on GitHub and all of the code can be viewed there but can also be edited when the repository is forked. Mythic is coded in Swift, Apple's open source language for apps. When you make changes on the fork, make sure to sync branch often and create a pull request so we can add it to Mythic.
