...
The icon that looks like a grid, changes the library layout between grid and list view. It is grid by default and this cannot currently be changed due to its bugginess.
