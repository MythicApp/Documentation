...
To import game launchers (such as Steam, Ubisoft, or EA) go [here](https://docs.getmythic.app/docs/miscellaneous/launchers)

To start, press the `+` next the search bar to start importing.
...
<Image
  ...
  height={750}
/>
`Select a game:`, the game has to be inside of your Epic Games library, so, select
the game you are importing.
