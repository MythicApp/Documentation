...
>
  <iframe
    ...
    src="https://www.youtube.com/embed/8OD3i1V2kIk"
    title="How to Install and Setup Mythic"
    frameborder="0"
...
It will then download and install, and then it will setup the default container that Mythic will use.
