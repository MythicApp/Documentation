...
<Image alt="Epic Games import menu" src="/mcontainers.png" width={750} height={750} />
Navigate to the `Wine` section on the sidebar on the left and pick the container you
want to change the scaling of.

Once you picked the container you want to change the settings of, press the gear icon to the right of the name and location of the container.
...
<Image
  ...
  height={750}
/>
At the bottom of the menu, there is a button that says `Launch Configurator` and
